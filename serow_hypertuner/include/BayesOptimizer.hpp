...
public:
    ...
    BayesOptimizer(DataManager& data_manager, size_t dim, const bayesopt::Parameters& params,
                   const double ate_position_weight, const double ate_orientation_weight,
...
private:
    ...
    /// @brief Optimization dataset percentage. e.g dataset_size * datset_percentage = total data to
