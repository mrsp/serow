...
PYBIND11_MODULE(serow, m) {
        ...
        .def(py::pickle(
            [](const serow::BaseState &state) { // __getstate__
                ...
                return py::make_tuple(
                    state.timestamp,
                    state.base_position,
                    quaternion_to_numpy(state.base_orientation),
                    ...
                    contacts_orientation_serialized,
                    state.base_position_cov,
                    state.base_orientation_cov,
                    ...
                    state.feet_position,
                    feet_orientation_serialized,
                    state.feet_linear_velocity,
            ...
            [](py::tuple t) { // __setstate__
                ...
                state.base_linear_acceleration = t[5].cast<decltype(state.base_linear_acceleration)>();
                state.base_angular_acceleration = t[6].cast<decltype(state.base_angular_acceleration)>();
                state.imu_angular_velocity_bias = t[7].cast<decltype(state.imu_angular_velocity_bias)>();
                state.imu_linear_acceleration_bias = t[8].cast<decltype(state.imu_linear_acceleration_bias)>();
                state.contacts_position = t[9].cast<decltype(state.contacts_position)>();
                
                // Handle optional contacts_orientation
                auto contacts_orientation_serialized = t[10].cast<std::map<std::string, py::array_t<double>>>();
                ...
                state.base_linear_velocity_cov = t[13].cast<decltype(state.base_linear_velocity_cov)>();
                state.base_angular_velocity_cov = t[14].cast<decltype(state.base_angular_velocity_cov)>();
                state.imu_angular_velocity_bias_cov = t[15].cast<decltype(state.imu_angular_velocity_bias_cov)>();
                state.imu_linear_acceleration_bias_cov = t[16].cast<decltype(state.imu_linear_acceleration_bias_cov)>();
                state.contacts_position_cov = t[17].cast<decltype(state.contacts_position_cov)>();
                state.contacts_orientation_cov = t[18].cast<decltype(state.contacts_orientation_cov)>();
                state.feet_position = t[19].cast<decltype(state.feet_position)>();
                
                // Convert feet_orientation from numpy arrays
                auto feet_orientation_serialized = t[20].cast<std::map<std::string, py::array_t<double>>>();
    ...
    py::class_<serow::ContactState>(m, "ContactState", "Represents the contact state of a humanoid robot")
        ...
        .def(py::pickle(
            [](const serow::ContactState &contact) { // __getstate__
                return py::make_tuple(
                    contact.timestamp,
                    contact.contacts_status,
                    contact.contacts_probability,
                    contact.contacts_force,
    ...
    py::class_<serow::ImuMeasurement>(m, "ImuMeasurement", "Represents IMU measurements")
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) { // __setstate__
                ...
                imu.angular_velocity_bias_cov = t[7].cast<decltype(imu.angular_velocity_bias_cov)>();
                imu.linear_acceleration_bias_cov = t[8].cast<decltype(imu.linear_acceleration_bias_cov)>();
    ...
    py::class_<serow::KinematicMeasurement>(m, "KinematicMeasurement", "Represents kinematic measurements")
        ...
        .def_property("base_to_foot_orientations", 
        ...
        .def_readwrite("base_to_foot_linear_velocities", &serow::KinematicMeasurement::base_to_foot_linear_velocities, "Map of base-to-foot linear velocities (string to 3D vector)")
        .def_readwrite("base_to_foot_angular_velocities", &serow::KinematicMeasurement::base_to_foot_angular_velocities, "Map of base-to-foot angular velocities (string to 3D vector)")
        ...
        .def(py::pickle(
            [](const serow::KinematicMeasurement &kin) { // __getstate__
                ...
                return py::make_tuple(
                    kin.timestamp,
                    kin.base_linear_velocity,
                    quaternion_to_numpy(kin.base_orientation),
                    kin.contacts_status,
                    kin.contacts_probability,
                    kin.contacts_position,
                    kin.base_to_foot_positions,
                    base_to_foot_orientations_serialized,
                    ...
                    kin.base_orientation_cov,
                    kin.position_slip_cov,
                    kin.orientation_slip_cov,
                    kin.position_cov,
                    kin.orientation_cov,
            ...
            [](py::tuple t) { // __setstate__
                ...
                kin.base_orientation = numpy_to_quaternion(t[2].cast<py::array_t<double>>());
                kin.contacts_status = t[3].cast<decltype(kin.contacts_status)>();
                kin.contacts_probability = t[4].cast<decltype(kin.contacts_probability)>();
                ...
                auto base_to_foot_orientations_serialized = t[7].cast<std::map<std::string, py::array_t<double>>>();
                for (const auto& [name, arr] : base_to_foot_orientations_serialized) {
                    kin.base_to_foot_orientations[name] = numpy_to_quaternion(arr);
                }
                
                kin.base_to_foot_linear_velocities = t[8].cast<decltype(kin.base_to_foot_linear_velocities)>();
                kin.base_to_foot_angular_velocities = t[9].cast<decltype(kin.base_to_foot_angular_velocities)>();
                kin.contacts_position_noise = t[10].cast<decltype(kin.contacts_position_noise)>();
                
                // Handle optional contacts_orientation
                auto contacts_orientation_serialized = t[11].cast<std::map<std::string, py::array_t<double>>>();
                if (!contacts_orientation_serialized.empty()) {
                    std::map<std::string, Eigen::Quaterniond> contacts_orientation;
                    for (const auto& [name, arr] : contacts_orientation_serialized) {
                        contacts_orientation[name] = numpy_to_quaternion(arr);
                ...
                kin.contacts_orientation_noise = t[12].cast<decltype(kin.contacts_orientation_noise)>();
                kin.com_angular_momentum_derivative = t[13].cast<decltype(kin.com_angular_momentum_derivative)>();
                ...
                kin.base_orientation_cov = t[17].cast<decltype(kin.base_orientation_cov)>();
                ...
                kin.com_linear_velocity_process_cov = t[23].cast<decltype(kin.com_linear_velocity_process_cov)>();
                kin.external_forces_process_cov = t[24].cast<decltype(kin.external_forces_process_cov)>();
                kin.com_position_cov = t[25].cast<decltype(kin.com_position_cov)>();
                kin.com_linear_acceleration_cov = t[26].cast<decltype(kin.com_linear_acceleration_cov)>();
