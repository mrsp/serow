...
PYBIND11_MODULE(serow, m) {
    ...
    py::class_<serow::ContactEKF>(m, "ContactEKF",
        ...
        .def("init", &serow::ContactEKF::init, py::arg("state"), py::arg("contacts_frame"),
             ...
             py::arg("outlier_detection") = false, py::arg("use_onnx") = false,
             py::arg("robot_name") = "", py::arg("model_path") = "policy/ddpg",
        ...
        .def(
            ...
            "terrain data")
        .def("set_action", &serow::ContactEKF::setAction, py::arg("contact_frame"),
             py::arg("action"), "Sets the action for the EKF for a given contact frame")
        .def(
            ...
            [](serow::ContactEKF& self, const std::string& contact_frame) {
                ...
                bool success = self.getContactPositionInnovation(
                    contact_frame, base_position, base_orientation, innovation, covariance);
                return std::make_tuple(success, base_position,
                                       quaternion_to_numpy(base_orientation), innovation,
                                       covariance);
            },
        ...
        .def(
            ...
            [](serow::ContactEKF& self, const std::string& contact_frame) {
                ...
                Eigen::Vector3d innovation = Eigen::Vector3d::Zero();
                Eigen::Matrix3d covariance = Eigen::Matrix3d::Zero();
                bool success = self.getContactOrientationInnovation(
                    contact_frame, base_position, base_orientation, innovation, covariance);
                return std::make_tuple(success, base_position,
                                       quaternion_to_numpy(base_orientation), innovation,
                                       covariance);
    ...
    py::class_<serow::Serow>(m, "Serow", "Main SEROW estimator class")
        ...
        .def("set_action", &serow::Serow::setAction, py::arg("contact_frame"), py::arg("action"),
