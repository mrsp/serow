...
if __name__ == "__main__":
    ...
    gt_pos = gt_pos[1000:(len(timestamps)+ 1000)]
    gt_rot = gt_rot[1000:(len(timestamps)+ 1000)]
    
    FL_forces = FL_forces[1000:(len(timestamps)+1000)]
    FR_forces = FR_forces[1000:(len(timestamps)+1000)]
    RL_forces = RL_forces[1000:(len(timestamps)+1000)]
    RR_forces = RR_forces[1000:(len(timestamps)+1000)]
