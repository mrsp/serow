...
/// Parameters
std::string original_config = getSerowPath() + "/config/go2.json";
std::string temp_config = getSerowPath() + "/config/go2_temp.json";
std::string best_config_file = getSerowPath() + "/config/go2_best_config.json";
std::string ground_truth_data = getSerowPath() + "/evaluation/mujoco_test/mujoco_data/flat_gamma/go2_data.h5";
std::string serow_predictions = getSerowPath() + "/evaluation/mujoco_test/mujoco_data/flat_gamma/serow_predictions.h5";
...
void runSerow()
{
  std::string cmd = "/home/michael/github/serow/evaluation/mujoco_test/build/go2_mujoco_test  go2_temp.json";
